...
<head>
    ...
    <title>read email - Bootdey.com</title>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-lg-3 email-aside border-lg-right">
              <div class="aside-content">
                <div class="aside-header">
                  ...
                  <a href="{{ route('dashboard') }}" class="btn btn-secondary btn-user">Kembali</a>
                </div>
                @if(session('success'))
                ...
                @endif
                <div class="aside-compose"><a class="btn btn-primary btn-block text-light" data-bs-toggle="modal" data-bs-target="#kirimModal">Kirim Email</a></div>
            ...
            <div class="col-lg-9 email-content">
                ...
                <div class="email-list-header d-flex justify-content-between align-items-center border-bottom pb-2 mb-2">
            <h5 class="p-1">Inbox</h5>
            <span class="badge bg-primary text-light mb-1">{{ $emails->count() }} Pesan Baru</span>
        </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered">
                  <div class="modal-content shadow-lg">
                    <div class="modal-header">
                      <h5 class="modal-title fw-bold" id="kirimModalLabel">Kirim Pesan</h5>
                    </div>
                    <div class="modal-body">
                      <form class="form-horizontal" role="form" method="POST" action="{{ route('mail.send') }}">
                        @csrf
