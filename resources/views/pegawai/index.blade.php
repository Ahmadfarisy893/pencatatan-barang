    ...
    <p>Ini adalah halaman daftar pegawai.</p>
        <div class="d-flex justify-content-between align-items-center mt-5 mb-3 gap-8">
            <input class="form-control" id="myInput" type="text" placeholder="Search..">
                <a href="{{ route('pegawai.create') }}" class="btn btn-primary d-flex align-items-center" style="height: 50px;" id=addP>
                    <i class="fas fa-plus me-2"></i> Tambah Pegawai
                </a>
        </div>
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-hover align-middle text-center overflow-hidden" id="tabelPegawai">
